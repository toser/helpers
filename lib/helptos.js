 ...
 * @returns {string}
 */
var buildLocalPath = exports.buildLocalPath = function buildLocalPath(filePath) {
    return _path2.default.join(__dirname, filePath);
};
 ...
 * @param filePath
 */
var getJSON = exports.getJSON = function getJSON(filePath) {
    return _fs2.default.readFileSync(buildLocalPath(filePath), 'utf8');
};
 ...
 * @returns {object}
 */
var getConfig = exports.getConfig = function getConfig(filePath) {
    return parseJSON(getJSON(filePath));
};
