...
exports.capitalize = exports.sortByDeepProp = exports.sortByProp = exports.copyArray = exports.copyObject = exports.shortenUrl = exports.getRandomEntry = exports.getNameList = exports.getFirstByType = exports.getFirstByName = exports.getByType = exports.getByName = exports.hasTypeValue = exports.hasNameValue = exports.hasPropValue = exports.anyHasPropSet = exports.hasAllPropsSet = exports.hasPropSet = exports.getConfig = exports.parseJSON = exports.getJSON = exports.buildLocalPath = undefined;
 ...
 * @returns {Function}
 */
var hasTypeValue = exports.hasTypeValue = function hasTypeValue(type) {
    return hasPropValue('type', type);
};
 ...
 * @returns {Array}
 */
var getByType = exports.getByType = function getByType(arr, type) {
    return arr.filter(hasTypeValue(type));
};
 ...
 * @returns {object}
 */
var getFirstByType = exports.getFirstByType = function getFirstByType(arr, type) {
    return getByType(arr, type)[0];
};
